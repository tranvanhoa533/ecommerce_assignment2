...
if ( !function_exists( 'wbc_extended_example' ) ) {
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        *************************************************************************/
        if ( class_exists( 'RevSlider' ) ) {
            ...
            $wbc_sliders_array = array(
                'Fashion'   => 'fashion_slider.zip', //Set slider zip name
                'Flowers'   => 'flowers_slider.zip', //Set slider zip name
                'Foods'     => 'food_slider.zip', //Set slider zip name
                'Furniture' => 'furniture_slider.zip', //Set slider zip name
                'Wines'     => 'wine_slider.zip', //Set slider zip name
                'Music'     => 'music_slider.zip', //Set slider zip name
            );
        ...
        *************************************************************************/
        ...
        // If it's demo1 - demo6
        $wbc_menu_array = array( 'Fashion', 'Flowers', 'Foods', 'Furniture', 'Wines', 'Music' );
        ...
        *************************************************************************/
        ...
        $wbc_home_pages = array(
            'Fashion'   => 'Shop Homepage',
            'Flowers'   => 'Shop Homepage',
            'Foods'     => 'Shop Homepage',
            'Furniture' => 'Shop Homepage',
            'Wines'     => 'Shop Homepage',
            'Music'     => 'Shop Homepage',
        );
