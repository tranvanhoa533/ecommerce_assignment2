...
function trend_register_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/js_composer.zip', // The plugin source
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/revslider.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/parallax-backgrounds-for-vc.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '3.6.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
        ),
        array(
            'name'                  => 'AMY Slider for Visual Composer', // The plugin name
            'slug'                  => 'ab_ct_amy_slider', // The plugin slug (typically the folder name)
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/ab_ct_amy_slider.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/mega_main_menu.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/inc/tgm/plugins/modeltheme-framework.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
