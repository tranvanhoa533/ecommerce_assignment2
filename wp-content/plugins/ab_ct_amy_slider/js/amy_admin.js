...
jQuery(function($) {
	...
	jQuery('#ct_amy_custom_meta_box .custom_clear_image_button').click(function() {
					
		var defaultImage = jQuery('#ct_amy_custom_meta_box .custom_default_image').text();
		jQuery('#ct_amy_custom_meta_box .custom_upload_image').val('');
		jQuery('#ct_amy_custom_meta_box .custom_preview_image').attr('src', defaultImage);
...
;( function( jQuery ) {
	...
	CBPFWTabs.prototype._init = function() {
		...
		// content items
		this.items = [].slice.call( this.el.querySelectorAll( '.content-wrap > ct_tt_section' ) );
	...
	CBPFWTabs.prototype._initEvents = function() {
		...
		this.tabs.forEach( function( tab, idx ) {
			tab.addEventListener( 'click', function( ev ) {
                //window.location.hash = '#!section-iconbox-' + idx;
                ev.preventDefault();
				self._show( idx );
			} );
		} );
	...
	CBPFWTabs.prototype._show = function( idx ) {
		...
		if( this.current >= 0 ) {
            ...
            jQuery('#section-iconbox-'+this.current).removeClass('tab-current');
            jQuery('.section-iconbox-'+this.current).removeClass('content-current');
           // jQuery('.section-iconbox-'+this.current).addClass('section-iconbox-'+this.current);
          //  this.items[ this.current ].className = 'section-iconbox-'+this.current;
		}
		...
		//this.items[ this.current ].className = 'section-iconbox-'+idx+' content-current';
        jQuery('#section-iconbox-'+this.current).addClass('tab-current');
        jQuery('.section-iconbox-'+this.current).addClass('content-current');
	};
