...
class PluginUpdate {
	...
	$slug = basename( $current_class->constant[ 'MM_WARE_INIT_FILE' ], '.php' );

	$ExampleUpdateChecker = new PluginUpdateChecker(
		'http://megamain.com/updates/index.php?purchase_code=' . $current_class->get_option( 'purchase_code' ) . '&folder=' . $slug . '&url=' . $siteurl,
